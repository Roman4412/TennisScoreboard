...
public class GameScoringStrategyTest {
  ...
  void count_ifPlayerWinsPoint_thenHisScoreIncrementsAndOpponentScoreUnchanged(
      String playerOneInit,
      String playerTwoInit,
      String playerOneExpected,
      String playerTwoExpected) {
    ...
    Assertions.assertAll(
        () ->
            Assertions.assertEquals(
                playerOneExpected, playerOneActual, "Incorrect scoring by the playerOne"),
        () ->
            Assertions.assertEquals(
                playerTwoExpected, playerTwoActual, "Incorrect scoring by the playerTwo"));
  }

  static Stream<Arguments> provideGameScoreVariants() {
    return Stream.of(
        Arguments.of(ZERO_PTS, ZERO_PTS, FIFTEEN_PTS, ZERO_PTS),
