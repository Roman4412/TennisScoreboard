...
public interface MatchMapper {
  ...
  @Mapping(source = "match", qualifiedByName = "getPlayerOneSetResult", target = "playerOneSetPts")
  @Mapping(source = "match", qualifiedByName = "getPlayerTwoSetResult", target = "playerTwoSetPts")
  @Mapping(
      source = "match",
      qualifiedByName = "getPlayerOneMatchResult",
      target = "playerOneMatchPts")
  @Mapping(
      source = "match",
      qualifiedByName = "getPlayerTwoMatchResult",
  ...
  @Mapping(source = "match", qualifiedByName = "getPlayerOneMatchPts", target = "playerOneMatchPts")
  @Mapping(
      source = "match",
      qualifiedByName = "getPlayerOneTiebreakPts",
  ...
  @Mapping(source = "match", qualifiedByName = "getPlayerTwoMatchPts", target = "playerTwoMatchPts")
  @Mapping(
      source = "match",
      qualifiedByName = "getPlayerTwoTiebreakPts",
  ...
  StoredMatchesDto toStoredMatchesDto(
      List<Match> matches, String name, int totalPages, int currentPage);
}
